...
def mostrar_ventana_registro():
    ...
    CTkButton(master=frame, text="Registrar", fg_color="#601E88", hover_color="#E44982", font=("Arial Bold", 14), text_color="#ffffff", width=225, command=lambda: registrar_usuario_registro(entry_nombre_registro.get(), entry_apellido_registro.get(), entry_nacimiento_registro.get(), entry_usuario_registro.get(), entry_contraseña_registro.get())).pack(pady=(25, 0), padx=(0, 0))
    
    CTkButton(master=frame, text="Volver", fg_color="#601E88", hover_color="#E44982", font=("Arial Bold", 14), text_color="#ffffff", width=225, command=mostrar_inicio_sesion).pack(pady=(10, 0), padx=(0, 0))
...
def registrar_usuario_registro(nombre, apellido, nacimiento, usuario, contraseña):
    ...
    año_de_nacimiento=("Año de Nacimiento:", nacimiento)
...
def consulta_con_administracion():
    pass
...
def inicio_sesion():
    limpiar_frame()
    CTkLabel(master=frame, text="Usted ha ingresado correctamente", text_color="#601E88", anchor="w", justify="left", font=("Arial Bold", 14)).pack(anchor="w", pady=(50, 5), padx=(50, 0))
    CTkButton(master=frame, text="Escanea tu computadora", fg_color="#601E88", hover_color="#E44982", font=("Arial Bold", 14), text_color="#ffffff", width=225, command=escanear_pc).pack(anchor="w", pady=(50, 5), padx=(45, 20))
    CTkButton(master=frame, text="Selector de juego", fg_color="#601E88", hover_color="#E44982", font=("Arial Bold", 14), text_color="#ffffff", width=225, command=selector_juego).pack(anchor="w", pady=(50, 5), padx=(45, 20))
    CTkButton(master=frame, text="Consultar con Administracion", fg_color="#601E88", hover_color="#E44982", font=("Arial Bold", 14), text_color="#ffffff", width=225, command=consulta_con_administracion).pack(anchor="w", pady=(50, 5), padx=(45, 20))
    CTkButton(master=frame, text="Cerrar Zembra", fg_color="#601E88", hover_color="#E44982", font=("Arial Bold", 14), text_color="#ffffff", width=225, command=cerrar_zembra).pack(anchor="w", pady=(50, 5), padx=(45, 20))
...
def mostrar_inicio_sesion():
    ...
    CTkButton(master=frame, text="Registrate", fg_color="#601E88", hover_color="#E44982", font=("Arial Bold", 12), text_color="#ffffff", width=225, command=mostrar_ventana_registro).pack(pady=(15, 0), padx=(0, 0))
    CTkButton(master=frame, text="Inicio de Sesion", fg_color="#601E88", hover_color="#E44982", font=("Arial Bold", 12), text_color="#ffffff", width=225, command=inicio_sesion).pack(pady=(15, 0), padx=(0, 0))

    CTkButton(master=frame, text="Continuar Con Google", fg_color="#EEEEEE", hover_color="#EEEEEE", font=("Arial Bold", 9), text_color="#601E88", width=225, image=google_icon).pack(anchor="w", pady=(15, 0), padx=(38, 0))
